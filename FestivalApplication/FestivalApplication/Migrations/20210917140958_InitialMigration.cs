        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageAuthorUserID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_User_MessageAuthorUserID",
                        column: x => x.MessageAuthorUserID,
                        principalTable: "User",
                        principalColumn: "UserID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_MessageAuthorUserID",
                table: "Message",
                column: "MessageAuthorUserID");
